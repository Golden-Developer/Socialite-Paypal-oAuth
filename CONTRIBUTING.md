# Contributing to Socialite-Paypal-oAuth

👍🎉 First off, thanks for taking the time to contribute! 🎉👍

The following is a set of guidelines for contributing to Socialite-Paypal-oAuth on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
2. **Clone the Repository.** Clone your forked repository to your local machine.
    ...
    ```bash
    git clone git@github.com:Golden-Developer/Socialite-Paypal-oAuth.git
    ```
